...
const PieChart = ({ questions, responses }) => {
    ...
    return {
      ...
      datasets: responses.map((survey, surveyIndex) => {
        ...
        return {
          ...
          backgroundColor: question.options.map(
            (_, idx) =>
              `rgba(${surveyIndex * 50 + idx * 20}, ${surveyIndex * 100}, ${
                surveyIndex * 150 + idx * 20
              }, 0.2)`
          ),
          borderColor: question.options.map(
            (_, idx) =>
              `rgba(${surveyIndex * 50 + idx * 20}, ${surveyIndex * 100}, ${
                surveyIndex * 150 + idx * 20
              }, 1)`
